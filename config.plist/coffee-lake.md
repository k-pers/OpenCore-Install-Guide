...
For users with black screen issues after verbose on B360, B365, H310, H370, Z390, please see the [BusID iGPU patching](https://k-pers.github.io/OpenCore-Post-Install/gpu-patching/intel-patching/busid.html) page
...
For us, we'll be using the boot-arg `alcid=xxx` instead to accomplish this. `alcid` will override all other layout-IDs present. More info on this is covered in the [Post-Install Page](https://k-pers.github.io/OpenCore-Post-Install/)
