...
* Follow [Fixing Resolution and Verbose](https://k-pers.github.io/OpenCore-Post-Install/cosmetic/verbose.html) for correct setup, set `UIScale` to `2` for HiDPI
