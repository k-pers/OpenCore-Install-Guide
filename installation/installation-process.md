...
* Read up on the [OpenCore Multiboot Guide](https://k-pers.github.io/OpenCore-Multiboot/) as well as [Setting up LauncherOption](https://k-pers.github.io/OpenCore-Post-Install/multiboot/bootstrap)
...
* The drive **must** also have a 200MB partition
  ...
  * See the [Multiboot Guide](https://k-pers.github.io/OpenCore-Multiboot/) for more info on partitioning a Windows Drive
