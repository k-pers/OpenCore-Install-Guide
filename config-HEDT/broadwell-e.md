...
| **[SSDT-RTC0-RANGE](https://k-pers.github.io/Getting-Started-With-ACPI/)** | Required for all Big Sur users to ensure their RTC device is compatible, see [Getting Started With ACPI Guide](https://k-pers.github.io/Getting-Started-With-ACPI/) for more details. |
| **[SSDT-UNC](https://k-pers.github.io/Getting-Started-With-ACPI/)** | Required for all Big Sur users to ensure their UNC devices are compatible, see [Getting Started With ACPI Guide](https://k-pers.github.io/Getting-Started-With-ACPI/) for more details. |
