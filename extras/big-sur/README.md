...
* [What's new in macOS 11, Big Sur!](https://k-pers.github.io/hackintosh/updates/2020/11/12/bigsur-new.html)
...
* BCM4331 and BCM43224 based WiFi cards.
  * See [Wireless Buyers guide](https://k-pers.github.io/Wireless-Buyers-Guide/) for potential cards to upgrade to.
...
* [Updating OpenCore and macOS](https://k-pers.github.io/OpenCore-Post-Install/universal/update.html)
...
* [Getting started with ACPI: Prebuilt SSDTs](https://k-pers.github.io/Getting-Started-With-ACPI/ssdt-methods/ssdt-prebuilt.html)
...
* XhciPortLimit broken in macOS 11.3 Beta 2 and newer
  * With macOS 11.3 and newer, [XhciPortLimit is broken resulting in boot loops](https://github.com/dortania/bugtracker/issues/162). We advise users either install an older OS(ie. macOS 10.15, Catalina) or find a 11.2.3 or older Big Sur installer
    ...
    * If you've already [mapped your USB ports](https://k-pers.github.io/OpenCore-Post-Install/usb/) and disabled `XhciPortLimit`, you can boot macOS 11.3+ without issue
...
This is due to [XhciPortLimit breaking with macOS 11.3 and newer](https://github.com/dortania/bugtracker/issues/162), to resolve you **must** disable XhciPortLimit under Kernel -> Quirks. Please ensure you've [mapped your USB ports correctly](https://k-pers.github.io/OpenCore-Post-Install/usb/) before doing so.
