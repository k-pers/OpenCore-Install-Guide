...
* GFX patches: Handled by [WhateverGreen](https://github.com/acidanthera/whatevergreen/releases)
  ...
  * change PEGP to GFX0
  * change SL01 to PEGP
* EC Patches: See here on best solution: [Getting started with ACPI](https://k-pers.github.io/Getting-Started-With-ACPI/)
  * change EC0 to EC
  * change H_EC to EC
  * change ECDV to EC
  * change PGEC to EC
* Audio renames: Handled by [AppleALC](https://github.com/acidanthera/AppleALC)
  ...
  * change ALZA to HDEF
  * change B0D3 to HDAU
* Z390 BIOS RTC bug fix: See here on best solution: [Getting started with ACPI](https://k-pers.github.io/Getting-Started-With-ACPI/)(SSDT-AWAC)
...
* **AddPNLF**:
  * See [SSDT-PNLF](https://k-pers.github.io/Getting-Started-With-ACPI/Laptops/backlight.html)
* **AddMCHC**:
  * [SSDT-SBUS-MCHC](https://github.com/acidanthera/OpenCorePkg/tree/master/Docs/AcpiSamples/Source/SSDT-SBUS-MCHC.dsl)
* **AddIMEI**:
  * [SSDT-SBUS-MCHC](https://github.com/acidanthera/OpenCorePkg/tree/master/Docs/AcpiSamples/Source/SSDT-SBUS-MCHC.dsl)
...
* **PluginType**:
  * [SSDT-PLUG](https://k-pers.github.io/Getting-Started-With-ACPI/Universal/plug.html)
  * See [Getting started with ACPI](https://k-pers.github.io/Getting-Started-With-ACPI/) for more details
...
* [GMA Patching](https://k-pers.github.io/OpenCore-Post-Install/gpu-patching/)
...
* [NVIDIA Patching](https://k-pers.github.io/OpenCore-Post-Install/gpu-patching/)
...
**Note**: See here on making an SSDT for GPU Spoofing, DeviceProperties injection via OpenCore seems to fail sometimes when trying to spoof a GPU: [Renaming GPUs](https://k-pers.github.io/Getting-Started-With-ACPI/Universal/spoof.html)
...
**NVIDIASingle**: See [disabling unsupported GPUs](https://k-pers.github.io/OpenCore-Post-Install/)
...
**Note**: If you still have issues, you'll need to use [RTCMemoryFixup](https://github.com/acidanthera/RTCMemoryFixup/releases) and exclude ranges. See [here for more info](https://github.com/acidanthera/bugtracker/issues/788#issuecomment-604608329), and [here](https://k-pers.github.io/OpenCore-Post-Install/misc/rtc.html) for a guide.
